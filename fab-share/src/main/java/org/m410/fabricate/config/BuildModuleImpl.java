 ...
 * @author m410
 */
public final class BuildModuleImpl implements BuildModule {
    ...
    public BuildModuleImpl() {
    }

    public BuildModuleImpl(String name, ImmutableConfiguration configuration) {
